...
3. **`data-pagefind-sort="date:..."` missing for presentations**: only relevant to a future FULL Pagefind decision. Not blocking anything today. Repository-evidenced in the P-OPEN-1 audit §3 and §8.
