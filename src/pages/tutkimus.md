...
<section class="py-5">
  <div class="container">
    ...
    {%- set countA = 0 -%}{%- set countC = 0 -%}{%- set countConf = 0 -%}{%- set countOther = 0 -%}
    {%- for pub in researchfi -%}
      {%- if pub.typeCode == "A1" or pub.typeCode == "A2" -%}{%- set countA = countA + 1 -%}
            ...
            <tr>
              ...
              <td>
                ...
                {% if pub.doi and semanticscholar.metrics.doiCitations[pub.doi | lower] %}
                  <span class="badge text-bg-warning rounded-pill ms-1" title="Viittaukset"><i class="bi bi-quote me-1"></i>{{ semanticscholar.metrics.doiCitations[pub.doi | lower] }}</span>
                {% endif %}
              </td>
...
<section class="py-5 bg-body-tertiary border-top border-bottom">
  <div class="container">
    ...
    <p class="text-muted mb-4">Ohjaamani opinnäytetyöt haetaan automaattisesti <a href="https://oulurepo.oulu.fi" target="_blank" rel="noopener noreferrer">OuluREPO-julkaisuarkistosta</a>{% if theses.stats.firstYear %} ({{ theses.stats.firstYear }}–{{ theses.stats.lastYear }}){% endif %}.</p>
          ...
          <div class="d-flex justify-content-between align-items-start gap-2">
            <div>
              <span class="fw-medium">
                {% if thesis.link %}<a href="{{ thesis.link }}" target="_blank" rel="noopener" class="text-decoration-none">{{ thesis.title }}</a>{% else %}{{ thesis.title }}{% endif %}
              </span>
      ...
      <div class="col-md-6">
        <div class="card border-0 shadow-sm h-100">
          <div class="card-body p-4">
            ...
            <p class="mb-3">Varhaisvaiheen tutkimus langattomien laitteiden mahdollisuuksista hajautetun asiantuntijuuden ja yhteisöllisen tiedonrakentelun välineinä – ennen älypuhelinaikaa.</p>
...
<section class="py-5 bg-body-tertiary border-top border-bottom">
  <div class="container">
    ...
    <p class="text-muted mb-5">Keskeisimmät tutkimushankkeet ja -kaudet uran varrelta.</p>
      ...
      <div class="col-md-10 offset-md-1">
        ...
        <div class="d-flex gap-3 mb-4 align-items-start">
          <div class="flex-shrink-0 text-center" style="width:90px">
            <span class="badge bg-success px-3 py-2">2024–</span>
          </div>
          <div class="card border-0 shadow-sm flex-grow-1">
            <div class="card-body p-3 p-md-4">
              <h3 class="h5 fw-bold mb-1">Generation AI</h3>
              <p class="text-muted small mb-2">Strategisen tutkimuksen neuvosto (STN) &mdash; Oulun yliopisto</p>
              <p class="mb-0">Tekoälylukutaitojen ja tekoälykasvatuksen tutkimus esi- ja perusopetuksessa. Vuorovaikutusasiantuntijana tutkimustiedon välittäminen opettajille ja kouluille.</p>
            </div>
          </div>
        </div>
        ...
        <div class="d-flex gap-3 mb-4 align-items-start">
          <div class="flex-shrink-0 text-center" style="width:90px">
            <span class="badge bg-secondary px-3 py-2">2006–2009</span>
          </div>
          <div class="card border-0 shadow-sm flex-grow-1">
            <div class="card-body p-3 p-md-4">
              <h3 class="h5 fw-bold mb-1">Monitieteinen tutkijakoulu</h3>
              <p class="text-muted small mb-2">Oulun yliopisto &mdash; Väitöskirjavaihe</p>
              <p class="mb-0">Väitöskirjatyö yhteisöllisten skriptien ja mobiililaitteiden tutkimuksesta. Monitieteinen tutkijakoulutus kasvatustieteen, teknologian ja kognitiotieteen rajapinnalla.</p>
            </div>
          </div>
        </div>
        ...
        <div class="d-flex gap-3 mb-4 align-items-start">
          <div class="flex-shrink-0 text-center" style="width:90px">
            <span class="badge bg-secondary px-3 py-2">2004–2005</span>
          </div>
          <div class="card border-0 shadow-sm flex-grow-1">
            <div class="card-body p-3 p-md-4">
              <h3 class="h5 fw-bold mb-1">EU FP6 Kaleidoscope Network of Excellence</h3>
              <p class="text-muted small mb-2">Euroopan unioni, 6. puiteohjelma &mdash; Teknologiatuettu oppiminen</p>
              <p class="mb-0">Kansainvälinen tutkimusverkosto teknologiatuetun oppimisen alalla. Yhteistyö eurooppalaisten yliopistojen ja tutkimuslaitosten kanssa CSCL-tutkimuksessa.</p>
            </div>
          </div>
        </div>
        ...
        <div class="d-flex gap-3 mb-4 align-items-start">
          <div class="flex-shrink-0 text-center" style="width:90px">
            <span class="badge bg-secondary px-3 py-2">2003–2004</span>
          </div>
          <div class="card border-0 shadow-sm flex-grow-1">
            <div class="card-body p-3 p-md-4">
              <h3 class="h5 fw-bold mb-1">TEKES Rotuuari</h3>
              <p class="text-muted small mb-2">Teknologian ja innovaatioiden kehittämiskeskus (TEKES) &mdash; Oulun yliopisto</p>
              <p class="mb-0">Mobiiliteknologian hyödyntäminen oppimisympäristöissä. Varhaisvaiheen tutkimus langattomista oppimisratkaisuista Suomessa.</p>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-6">
        ...
        <div class="list-group list-group-flush border rounded">
          <div class="list-group-item px-4 py-3">
            ...
            <div class="small mt-1 text-success fw-bold">21&thinsp;000 €</div>
          </div>
          <div class="list-group-item px-4 py-3">
            <div class="d-flex justify-content-between align-items-start">
              <div>
            ...
            <div class="small mt-1 text-success fw-bold">1&thinsp;500 €</div>
          </div>
          <div class="list-group-item px-4 py-3">
            <div class="d-flex justify-content-between align-items-start">
              <div>
            ...
            <div class="small mt-1 text-success fw-bold">16&thinsp;400 €</div>
          </div>
        </div>
      </div>
          ...
          <div class="card-body p-4">
            <div class="d-flex gap-3 align-items-start">
              ...
              <div>
                ...
                <p class="mb-2 small">Palkinto myönnettiin pitkäaikaisesta avoimuuden edistämisestä opetuksessa, avointen oppimisalustojen käytöstä ja aktiivisesta tuen tarjoamisesta etäopetuksessa koronapandemian aikana.</p>
          ...
          <div class="card-body p-4">
            <div class="d-flex gap-3 align-items-start">
              ...
              <div>
                ...
                <p class="mb-0 small">LO11-B-opiskelijaryhmän tunnustus erinomaisesta opetuksesta. Opiskelijapalautetta on kerätty myös <a href="/opiskelijoiden-antamaa-palautetta/">palautesivulle</a>.</p>
              </div>
            </div>
          </div>
        </div>
