...
<section class="py-5">
  <div class="container">
    ...
    <h2 class="h4 mb-4">Vaalit ja vaalikaudet</h2>
    ...
    <h2 class="h4 mb-4 mt-2">Muut luottamustoimet</h2>
    <div class="card border-0 shadow-sm">
      <div class="card-body p-4">
        <ul class="mb-0">
          <li><strong>Yliopistokollegion jäsen</strong>, Oulun yliopisto (nykyinen)</li>
          <li><strong>Asukasyhdistyksen puheenjohtaja</strong>, Jäälin alue (2000-luku)</li>
          <li><strong>OYY hallituksen jäsen</strong>, Oulun yliopiston ylioppilaskunta, 2000</li>
        </ul>
      </div>
    </div>

    <div class="mt-4 d-flex gap-2">
      <a class="btn btn-primary" href="/politiikka/">Jari Laru, poliitikko</a>
