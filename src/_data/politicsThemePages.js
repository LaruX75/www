...
const companionPages = [
  {
    ...
    eyebrow: "Päälinja 1",
    description: "Kampusratkaisut, normaalikoulun tilat, Raksilan kehittäminen ja Linnanmaan merkitys osana Oulun kaupunkirakennetta.",
    lead: "Tämä kokonaisuus kokoaa yhteen pitkän kampus- ja kaupunkirakennekeskustelun. Kyse ei ole vain yliopiston sijainnista, vaan siitä, miten tutkimus, opetus, yritykset, palvelut ja kaupungin investoinnit rakentuvat samaan kokonaisuuteen.",
    principle: "Kampusratkaisuja pitää arvioida sivistyksen, kaupunkirakenteen, talouden ja arjen toimivuuden näkökulmasta, ei yksittäisen vetovoimahankkeen ehdoilla.",
    accent: "#0d6efd",
    statLabel: "vuosien keskustelu",
    statValue: "2020–2025",
    profileLabels: [
      "Sivistys ja oppiminen",
      "Kaupunkikehitys ja kaupunkirakenne",
      "Avoin valmistelu ja tiedolla johtaminen"
    ],
    focus: [
      "Linnanmaan monitieteinen kokonaisuus",
      "Raksilan kehittäminen ja kokonaisvaikutukset",
      "Normaalikoulun terveet ja toimivat tilat",
      "Yliopiston, kaupungin ja yritysten kasautumisedut"
    ],
    timeline: [
      {
        year: "2020",
  ...
  {
    key: "palveluverkko",
    permalink: "/politiikka/palveluverkko/",
    title: "Palveluverkko ja kaupunginosat",
    eyebrow: "Päälinja 2",
    description: "Oulun palveluverkko, kouluverkko, väestösuunnitteet ja koko kaupungin alueellinen yhdenvertaisuus.",
    lead: "Palveluverkko on kysymys siitä, miten Oulun 23 suuraluetta ja kaupunginosat pysyvät mukana kaupungin muutoksessa. Päätösten pitää perustua tietoon, mutta tiedon on oltava ymmärrettävää ja alueellisesti reilusti tulkittua.",
    principle: "Kouluja, päiväkoteja ja muita lähipalveluja pitää tarkastella koko Oulun mittakaavassa: palvelujen saavutettavuus, väestökehitys, talous ja kaupunginosien arki samassa kuvassa.",
    accent: "#198754",
    statLabel: "pääaineistot",
    statValue: "2023–2026",
    profileLabels: [
    ...
    focus: [
      "koulu- ja päiväkotiverkon vaikutukset",
      "väestösuunnitteet ja syntyvyyden muutos",
      "suuralueiden ja kaupunginosien tasapuolinen kehitys",
      "palvelujen saavutettavuus ja arjen toimivuus"
    ],
    timeline: [
      {
        year: "2018",
  ...
  },
  {
    ...
    permalink: "/politiikka/avoin-valmistelu/",
    title: "Avoin valmistelu ja tiedolla johtaminen",
    eyebrow: "Päälinja 3",
    description: "Valmistelun läpinäkyvyys, päätöksenteon seurattavuus, avoin data ja tiedolla johtaminen kunnallispolitiikassa.",
    lead: "Avoimuus ei tarkoita vain sitä, että päätösasiakirjat ovat jossain saatavilla. Valmistelun pitää olla ymmärrettävää, päätösten vaikutuksia pitää voida arvioida ja päättäjien sekä kuntalaisten pitää nähdä, missä vaiheessa asiat oikeasti ratkaistaan.",
    principle: "Päätöksenteon luottamus syntyy siitä, että valmistelun vaiheet, toimivalta, aineistot ja perustelut ovat näkyvissä ennen kuin ratkaisut lukitaan.",
    accent: "#6f42c1",
    statLabel: "ydinkysymys",
    statValue: "avoimuus",
    profileLabels: [
      "Avoin valmistelu ja tiedolla johtaminen",
      "Sivistys ja oppiminen",
    ...
    focus: [
      "valmistelun vaiheet ja toimivalta",
      "avoimet asiakirjat ja seurattavat pöytäkirjat",
      "tiedolla johtamisen työkalut",
      "sidonnaisuudet ja vaalirahoituksen läpinäkyvyys"
    ],
    timeline: [
      {
        year: "2021–2022",
  ...
  {
    key: "sivistys-ja-koulutus",
    permalink: "/politiikka/sivistys-ja-koulutus/",
    title: "Sivistys ja koulutus",
    eyebrow: "Päälinja 4",
    description: "Perusopetus, sivistyslautakunta, opettajankoulutus ja tekoälylukutaito kunnallis- ja kansallispolitiikassa.",
    lead: "Sivistys on kaupungin perusinfra siinä missä katu tai vesijohto. Perusopetuksen laatu, opettajien osaaminen ja lasten oppiminen ovat kysymyksiä, joita on arvioitava koko kaupungin mittakaavassa ja pitkällä aikajanalla.",
    principle: "Sivistyspalveluja pitää arvioida sivistyksen omalla logiikalla: oppimisen tuki, opettajien osaaminen ja lasten arki ratkaisevat, ei tila- tai talouslinjaus yksin.",
    accent: "#d97706",
    statLabel: "sivistyslautakunta",
    statValue: "2021–",
    profileLabels: [
      "Sivistys ja oppiminen",
      "Palveluverkko ja kaupunginosat",
    ...
    focus: [
      "perusopetuksen laatu ja oppimisen tuki",
      "sivistyslautakunnan päätöksenteko",
      "tekoälylukutaito opetuksessa ja lainsäädännössä",
      "opettajien osaaminen ja opettajankoulutus"
    ],
    timeline: [
      {
        year: "2022",
      ...
      {
        year: "2025–2026",
        title: "Tekoälylukutaito politiikan ja opetuksen ytimessä",
        text: "Tekoälylukutaidosta tuli sivistys- ja koulutuspolitiikan keskiö. Kansallinen viitekehys, palkitut oppimisratkaisut ja yleistajuinen materiaali tuovat aiheen kuntalaisen arkeen.",
        links: [
          {
    ...
    evidenceNotes: [
      "Aineisto yhdistää valtuustopuheita, lausuntoja OKM:lle ja eduskunnalle, blogitekstejä sekä mediahaastatteluja tekoälystä ja opetuksesta.",
      "Sivistys näkyy sekä paikallispolitiikassa (sivistyslautakunta, kouluverkko) että kansallisessa lainsäädäntötyössä (lausunnot perusopetuslakiin ja tekoälysääntelyyn).",
      "Ammattiroolin (opettajankouluttaja, tutkija) ja poliittisen roolin (sivistyslautakunta) välinen kytkös näkyy erityisesti tekoälylukutaidon kysymyksissä."
    ],
    editorialNote: "Kokonaisuus painottuu teksteihin, joissa sivistyslautakunnan työ, kouluverkon opetuksellinen näkökulma tai tekoälylukutaidon lainsäädäntö nousevat itsenäiseksi asiakysymykseksi. Puhtaasti ammatilliset esitykset ja pedagogiset materiaalit löytyvät teemaprofiileista.",
    nextLinks: [
      { label: "Sivistyslautakunta", href: "/politiikka/sivistyslautakunta/" },
      { label: "Opettajankoulutus (teemaprofiili)", href: "/teemat/opettajankoulutus/" },
      { label: "Tekoälylukutaito (teemaprofiili)", href: "/teemat/tekoalylukutaito/" }
    ],
    linkedTopic: {
      slug: "opettajankoulutus",
      label: "Opettajankoulutus ja opetuksen kehittäminen"
    }
  }
];
